...
public:
	...
	virtual HRESULT STDMETHODCALLTYPE GetHostInfo( 
		...
		/* [out][in] */ DWORD *pdwDoubleClick) {
            *pdwFlags = (*pdwFlags) | DOCHOSTUIFLAG_NO3DOUTERBORDER | DOCHOSTUIFLAG_ENABLE_FORMS_AUTOCOMPLETE
                | DOCHOSTUIFLAG_THEME | DOCHOSTUIFLAG_NO3DBORDER;
            return S_OK;
    }
	...
	virtual HRESULT STDMETHODCALLTYPE EnableModeless( 
		/* [in] */ VARIANT_BOOL fEnable) {return S_OK;}
...
//
        ...
        void SetExternalDisp(IDispatch* disp);
    private:
        CComPtr<IDispatch> m_dispExternal;
